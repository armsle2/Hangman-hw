...
// console.log(wordChooser)
	wordChooser.forEach(function(entry) {
    console.log(entry);
    $("#game-word").append("<span style='visibility: hidden'>" + entry + "</span>")
    //use jquery DOM below to change css on html tag/attribute
	// $('span:contains()').css('visibility', 'visible');
...
//insert a word into html invisibly


//method below allows us to display each string in array on html surrounded by span or anything we want
...
// function hide(){
// $(gameWord).css("visibility", "hidden")
